...
<section class="section">
  <h1 class="section-title">Gérer les annonces</h1>
  ...
  <div class="grid-two">
    <div>
      <div class="empty-state">
        ...
        <form method="post">
          ...
          <div class="stack" style="margin-bottom:12px;">
            <label style="color: var(--muted); font-weight:800; flex:1; min-width: 240px;">
              Catégorie
              <select
                name="category_slug"
                style="width:100%; margin-top:6px; padding: 10px 12px; border-radius: 12px; border:1px solid rgba(255,255,255,.16); background: rgba(0,0,0,.12); color: var(--text);"
              >
    ...
    <div>
      <div class="empty-state">
        <h2 style="margin-top:0;">Dernières annonces</h2>
        <?php if (!$items): ?>
